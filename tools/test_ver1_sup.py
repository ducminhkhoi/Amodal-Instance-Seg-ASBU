...
class Tester(object):
    ...
    def infer(self):
        ...
        # list_order_matrices = []
        list_order_matrices = torch.load('experiments/COCOA/val_order_matrices.pkl')
        ...
        for i in range(self.data_length):
            ...
            # list_order_matrices.append(order_matrix)
            # continue
            order_matrix = list_order_matrices[i]
        ...
        # torch.save(list_order_matrices, 'experiments/KINS/test_order_matrices.pkl')
        # exit()
